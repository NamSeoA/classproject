...
<body>
	...
	<fmt:formatNumber value="1000000"/>   <!-- 기본 number 타입 -->
	<fmt:formatNumber value="1000000" groupingUsed="false"/> <!-- , 제외 -->
			
	<c:set var="number" value="10000000"/> <%-- scope="page"  -> scope 생략시 속성에 자동 저장 --%>
